...
const DashboardSidebar = ({ menuItems, sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <div className={`bg-gray-900 text-white transition-all duration-300 border-red-800 flex flex-col ${sidebarOpen ? 'w-64' : 'w-20'
            }`}
        >
            <div className="p-4 border-b border-gray-800 flex items-center justify-between">
                ...
                {sidebarOpen ? (
                    <>
                        ...
                        <h1 className="text-xl font-bold">EWU Portal</h1>
                        <button
                ...
                <div className="p-4 border-t border-gray-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            <div className="text-xs text-gray-400">{appUser?.firstName + ' ' + appUser?.lastName || 'Invalid User'}</div>
                        </div>
                    </div>
                </div>
            )}
